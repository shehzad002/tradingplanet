    ...
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p> Tp will be the home of our new frontend, and provides
              an interface for all interactions with the PancakeSwap protocol.
          </p>
          <p> Development will be on going, and tpswap will still
              exist in the interim as we work to get Tp completely
              polished.
          </p>
        </div>
      )
